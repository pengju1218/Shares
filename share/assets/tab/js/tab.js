...
tab.show = function (arrayStr, arrayHtml, addId) {
	...
	for (var i = 0; i < arrayHtml.length; i++) {
		...
		var sr = "<div  class='tabList' id='html_1'><iframe align='center' width='100%' height='800' " +
			" src='" + arrayHtml[i] + "'  frameborder='no' border='0' " +
	...
	if (addId == null || document.getElementById(addId) == null) {
		document.body.appendChild(wrap_div);
	} else {
		document.getElementById(addId).appendChild(wrap_div);
	}
